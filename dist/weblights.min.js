(function () {
  ...
  var ErrReadTimeout = "read timeout";
  function readInterruptSignal(timeoutMillis) {
    return new Promise(function (_, reject) {
      setTimeout(function () {
        return reject(new Error(ErrReadTimeout));
      }, timeoutMillis);
    });
  }
          ...
          return _regeneratorRuntime().wrap(function _callee$(_context) {
            while (1) switch (_context.prev = _context.next) {
              ...
              case 19:
                ...
                if (_context.t0.message !== ErrReadTimeout) {
  ...
  var SequenceReader = /*#__PURE__*/function () {
    function SequenceReader(dataView) {
      _classCallCheck(this, SequenceReader);
      _classPrivateFieldInitSpec(this, _dataView, {
        writable: true,
        value: void 0
      });
      _classPrivateFieldSet(this, _dataView, dataView);
    }
    _createClass(SequenceReader, [{
      key: "isValidMagic",
      value: function isValidMagic() {
        return _classPrivateFieldGet(this, _dataView).getUint32(0, true) === 1363497808;
      }
    }, {
      key: "getVersion",
      value: function getVersion() {
        var minor = _classPrivateFieldGet(this, _dataView).getUint8(6);
        var major = _classPrivateFieldGet(this, _dataView).getUint8(7);
        return "".concat(major, ".").concat(minor);
      }
    }, {
      key: "getChannelCount",
      value: function getChannelCount() {
        return _classPrivateFieldGet(this, _dataView).getUint32(10, true);
      }
    }, {
      key: "getDuration",
      value: function getDuration() {
        var duration = {
          frameCount: _classPrivateFieldGet(this, _dataView).getUint32(14, true),
          stepTimeMillis: _classPrivateFieldGet(this, _dataView).getUint8(18)
        };
      ...
      value: function isCompressed() {
        var compressionFlags = _classPrivateFieldGet(this, _dataView).getUint8(20);
  ...
  function CompatibleBrowserTest() {
    if ("serial" in navigator) {
      ...
      return module.createElement(OpenSequence, null);
    } else {
  ...
  function SelectSerialPort() {
    var handleDisconnectedSerialPort = function handleDisconnectedSerialPort() {
  ...
  function OpenSequence() {
    var handleFileSelected = function handleFileSelected(event) {
      ...
      fileReader.onload = /*#__PURE__*/function () {
        var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(event) {
          ...
          return _regeneratorRuntime().wrap(function _callee2$(_context2) {
            while (1) switch (_context2.prev = _context2.next) {
              case 0:
                sequenceReader = new SequenceReader(new DataView(event.target.result));
                if (sequenceReader.isValidMagic()) {
                  render(module.createElement(SequenceInfo, {
      ...
      fileReader.onerror = /*#__PURE__*/function () {
    ...
    return module.createElement("div", null, module.createElement("input", {
      "class": "form-control",
      type: "file",
      accept: ".fseq",
  ...
  function SequenceInfo(_ref3) {
    var sequenceReader = _ref3.sequenceReader;
    var duration = sequenceReader.getDuration();
    return module.createElement("div", null, module.createElement("strong", null, "Sequence Info"), module.createElement("ul", null, module.createElement("li", null, "FSEQ version ", sequenceReader.getVersion()), module.createElement("li", null, "Channel count: ", sequenceReader.getChannelCount()), module.createElement("li", null, duration.frameCount, " frames @ ", duration.stepTimeMillis, "ms step time"), module.createElement("li", null, Math.round(duration.durationMillis / 1000), " seconds total duration")), sequenceReader.isCompressed() ? module.createElement("div", null, module.createElement("div", {
      "class": "alert alert-danger"
    }, "Sequence is compressed, and must be decompressed before it can be used with weblights as we have not added support for decompressing the file in the browser (yet)."), module.createElement("button", {
      type: "button",
      "class": "btn-link",
      onclick: function onclick() {
        return render(module.createElement(OpenSequence, null), AppElement);
      }
    }, "Select a different sequence")) : module.createElement("div", null, module.createElement("button", {
      type: "button",
      "class": "btn-success"
    }, "Play Sequence")));
  }
  function TestConnection(_ref4) {
    var serialPort = _ref4.serialPort;
  ...
  function ActiveConnection(_ref5) {
    var io = _ref5.io,
      connectedUnits = _ref5.connectedUnits;
    var closeSerialPort = /*#__PURE__*/function () {
      var _ref6 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4() {
        return _regeneratorRuntime().wrap(function _callee4$(_context4) {
          while (1) switch (_context4.prev = _context4.next) {
            ...
            case 5:
              ...
              console.error("error while closing connection:", _context4.t0);
            case 8:
              _context4.prev = 8;
        ...
        }, _callee4, null, [[0, 5, 8, 11]]);
      }));
      return function closeSerialPort() {
